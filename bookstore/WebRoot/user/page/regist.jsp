...
<div class="parent">
  <div class="container">
    <div class="panel rt">
      <form id="fm-register" method="post" action="${pageContext.request.contextPath}/servlet/RegisterServlet">
        <div class="txt">
          <p id="newuser">新用户注册
            <span>
  ...
  $('#email').blur(function(){
    if(this.validity.valueMissing){
      ...
      $.ajax({
		  ...
		  url:'${pageContext.request.contextPath}/servlet/CheckEmailServlet',
		  success:function(data){
	          //console.log('开始处理响应数据');
	          // alert("*"+data+"*");
	          if(data=='yes'){
  ...
  $('#phone').blur(function(){
    if(this.validity.valueMissing){
      ...
      $.ajax({
		  ...
		  url:'${pageContext.request.contextPath}/servlet/CheckPhoneServlet',
		  success:function(data){
	          console.log('开始处理响应数据');
	          // alert("*"+data+"*");
	          if(data=='yes'){
	            $("#phone").next().text("该号码被占用");
